          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="text-center group transition-transform duration-300 hover:scale-105 text-white" style={{ backgroundColor: 'hsl(var(--foreground))' }}>
                <CardHeader>
                  <div className="mx-auto rounded-full p-4 w-20 h-20 flex items-center justify-center transition-transform duration-300 group-hover:scale-110" style={{ backgroundColor: 'white' }}>
